...
brownt1 = ets.ExponentialSmoothing(spyt, trend=None, damped_trend=False, seasonal=None).fit()
print('')
...
brownf2 = ets.ExponentialSmoothing(spyf1, trend=None, damped_trend=False, seasonal=None).fit(
...
holtt1 = ets.ExponentialSmoothing(spyt, trend='additive', damped_trend=False, seasonal=None).fit()
print('')
print('== Holt Linear Trend ETS(A,A,N) Parameters ==')
print('')
print('Smoothing Level: ', np.round(holtt1.params['smoothing_level'], 4))
print('Smoothing Slope: ', np.round(holtt1.params['smoothing_trend'], 4))
print('Initial Level: ', np.round(holtt1.params['initial_level'], 4))
print('Initial Slope: ', np.round(holtt1.params['initial_trend'], 4))
print('')
...
holtf2 = ets.ExponentialSmoothing(spyf1, trend='additive', damped_trend=False, seasonal=None).fit(
    smoothing_level=holtt1.params['smoothing_level'], smoothing_slope=holtt1.params['smoothing_trend'])
...
expt1 = ets.ExponentialSmoothing(spyt.iloc[:, 0].values, trend='multiplicative', damped_trend=False,
                                 seasonal=None).fit()
print('')
print('== Exponential Trend ETS(A,M,N) Parameters ==')
print('')
print('Smoothing Level: ', np.round(expt1.params['smoothing_level'], 4))
print('Smoothing Slope: ', np.round(expt1.params['smoothing_trend'], 4))
print('Initial Level: ', np.round(expt1.params['initial_level'], 4))
print('Initial Slope: ', np.round(expt1.params['initial_trend'], 4))
print('')
...
expf2 = ets.ExponentialSmoothing(spyf1.iloc[:, 0].values, trend='multiplicative', damped_trend=False,
                                 seasonal=None).fit(smoothing_level=expt1.params['smoothing_level'],
                                                    smoothing_slope=expt1.params['smoothing_trend'])
...
gardnert1 = ets.ExponentialSmoothing(spyt, trend='additive', damped_trend=True, seasonal=None).fit()
print('')
...
print('Smoothing Slope: ', np.round(gardnert1.params['smoothing_trend'], 4))
print('Damping Slope: ', np.round(gardnert1.params['damping_trend'], 4))
print('Initial Level: ', np.round(gardnert1.params['initial_level'], 4))
print('Initial Slope: ', np.round(gardnert1.params['initial_trend'], 4))
print('')
...
gardnerf2 = ets.ExponentialSmoothing(spyf1, trend='additive', damped_trend=True, seasonal=None).fit(
    smoothing_level=gardnert1.params['smoothing_level'], smoothing_trend=gardnert1.params['smoothing_trend'],
    damping_slope=gardnert1.params['damping_trend'])
...
taylort1 = ets.ExponentialSmoothing(spyt.iloc[:, 0].values, trend='multiplicative', damped_trend=True,
                                    seasonal=None).fit()
print('')
...
print('Smoothing Slope: ', np.round(taylort1.params['smoothing_trend'], 4))
print('Damping Slope: ', np.round(taylort1.params['damping_trend'], 4))
print('Initial Level: ', np.round(taylort1.params['initial_level'], 4))
print('Initial Slope: ', np.round(taylort1.params['initial_trend'], 4))
print('')
...
taylorf2 = ets.ExponentialSmoothing(spyf1.iloc[:, 0].values, trend='multiplicative', damped_trend=True,
                                    seasonal=None).fit(smoothing_level=taylort1.params['smoothing_level'],
                                                       smoothing_trend=taylort1.params['smoothing_trend'],
                                                       damping_slope=taylort1.params['damping_trend'])
...
hwat1 = ets.ExponentialSmoothing(spyt, trend='additive', damped_trend=False, seasonal='additive',
...
print('Smoothing Slope: ', np.round(hwat1.params['smoothing_trend'], 4))
...
print('Initial Slope: ', np.round(hwat1.params['initial_trend'], 4))
...
hwaf2 = ets.ExponentialSmoothing(spyf1, trend='additive', damped_trend=False, seasonal='additive',
                                 seasonal_periods=22).fit(smoothing_level=hwat1.params['smoothing_level'],
                                                          smoothing_slope=hwat1.params['smoothing_trend'],
...
hwmt1 = ets.ExponentialSmoothing(spyt.iloc[:, 0].values, trend='additive', damped_trend=False,
...
print('Smoothing Slope: ', np.round(hwmt1.params['smoothing_trend'], 4))
...
print('Initial Slope: ', np.round(hwmt1.params['initial_trend'], 4))
...
hwmf2 = ets.ExponentialSmoothing(spyf1.iloc[:, 0].values, trend='additive', damped_trend=False,
                                 seasonal='multiplicative',
                                 seasonal_periods=22).fit(smoothing_level=hwmt1.params['smoothing_level'],
                                                          smoothing_slope=hwmt1.params['smoothing_trend'],
